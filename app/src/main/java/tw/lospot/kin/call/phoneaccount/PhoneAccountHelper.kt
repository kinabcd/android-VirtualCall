...
class PhoneAccountHelper(context: Context, private val address: String = "default@lospot.tw") {
    ...
    val isEnabled get() = isRegistered && phoneAccount?.isEnabled ?: false
    val isSelfManaged get() = isRegistered && phoneAccount?.hasCapabilities(PhoneAccount.CAPABILITY_SELF_MANAGED) ?: false
